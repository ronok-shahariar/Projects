...
main_application: object = tk.Tk()
main_application.geometry('1020x500')
main_application.title('RIoT Text Editor')
#main_application.iconbitmap('C:/Users/Ronok Arya/Python VS_Cdoe/Editor pad/icons/icon3.ico')
main_application.wm_iconbitmap('icon4.ico')
...
##### color theme
light_default_icon = tk.PhotoImage(file='icons/light.png')
...
## about
pic = tk.PhotoImage(file='icons/pic.png')

about = tk.Menu(main_menu, tearoff=False)
about.add_command(image=pic)
about.add_command(label='Shahariar Hassan Ronok')
about.add_command(label='346ronokarya@gmail.com')
about.add_command(label='')
about.add_command(label='          Version 1.0')
...
def exit_func(event=None):
    ...
    try:
        if text_changed:
            ...
            if mbox is True:
                if url:
                    content = text_editor.get(1.0, tk.EnND)
                    with open(url, 'w', encoding='utf-8') as fw:
                        fw.write(content)
