...
__all__ = [ 'OLE_CANCELBOOL', 'Color', 'OLE_XPOS_PIXELS', 'IFontDisp',
           'OLE_YPOS_CONTAINER', 'OLE_YSIZE_CONTAINER',
           'OLE_YPOS_HIMETRIC', 'Default', 'OLE_HANDLE', 'Checked',
           'Monochrome', 'FONTUNDERSCORE', 'Unchecked', 'Picture',
           'FONTSTRIKETHROUGH', 'OLE_XPOS_CONTAINER',
           'OLE_YSIZE_HIMETRIC', 'OLE_XSIZE_HIMETRIC',
           'OLE_XSIZE_CONTAINER', 'Gray', 'OLE_COLOR', 'FONTITALIC',
           'FONTNAME', 'OLE_YPOS_PIXELS', 'FontEvents', 'FONTSIZE',
           'IFontEventsDisp', 'IFont', 'StdPicture', 'FONTBOLD',
           'OLE_XPOS_HIMETRIC', 'OLE_XSIZE_PIXELS', 'IPictureDisp',
           'OLE_TRISTATE', 'Font', 'LoadPictureConstants', 'IPicture',
           'VgaColor', 'OLE_YSIZE_PIXELS', 'OLE_OPTEXCLUSIVE',
           'OLE_ENABLEDEFAULTBOOL', 'StdFont']
from comtypes import _check_version; _check_version('1.1.9', 1377171877.807966)
